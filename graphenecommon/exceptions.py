...
class WalletExists(Exception):
    """A wallet has already been created and requires a password to be unlocked by means
    of :func:`wallet.unlock`."""
...
class NoWalletException(Exception):
    """No Wallet could be found, please use :func:`wallet.create` to create a new
    wallet."""

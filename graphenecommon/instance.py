...
class AbstractBlockchainInstanceProvider:
    ...
    It will extract 'blockchain_instance' from the key word arguments and ensure that
    self.blockchain contains an instance of the main chain instance
    """
    ...
    def shared_blockchain_instance(self):
        ...
        The purpose of this method is to have offer single default instance that can be
    ...
    def set_shared_config(cls, config):
        ...
        ``shared_blockchain_instance`` and allows to define the configuration without
        requiring to actually create an instance."""

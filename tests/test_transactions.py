...
class Testcases(unittest.TestCase):
    ...
    def test_signed_transaction(self):
        self.op = Account_create(**{
            ...
            "owner": {"weight_threshold": 1,
                      "account_auths": [],
                      'key_auths': [['GPH6pbVDAjRFiw6fkiKYCrkz7PFeL7XNAfefrsREwg8MKpJ9VYV9x', 1]],
                      "address_auths": []
                      },
            ...
            "options": {"memo_key": "GPH5TPTziKkLexhVKsQKtSpo4bAv5RnB8oXcG4sMHEwCcTf3r7dqE",
        ...
        self.assertIn("chain_id", tx.getChainParams({'chain_id': 'b8d1603965b3eb1acba27e62ff59f74efa3154d43a4188d381088ac7cdf35539', 'core_symbol': 'CORE', 'prefix': 'GPH'}))
        with self.assertRaises(ValueError):
            self.assertIn("chain_id", tx.getChainParams({'core_symbol': 'CORE', 'prefix': 'GPH'}))
        with self.assertRaises(ValueError):
        ...
        with self.assertRaises(MissingSignatureForKey):
            tx.verify([PublicKey("GPH6pbVDAjRFiw6fkiKYCrkz7PFeL7XNAfefrsREwg8MKpJ9VYV9x")])
    ...
    def test_create_account(self):
        self.op = Account_create(**{
            ...
            "owner": {"weight_threshold": 1,
                      "account_auths": [],
                      'key_auths': [['GPH6pbVDAjRFiw6fkiKYCrkz7PFeL7XNAfefrsREwg8MKpJ9VYV9x',
                                    1], [
